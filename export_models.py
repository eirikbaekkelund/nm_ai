...
YOLO: Exported to ONNX (sandbox has ultralytics 8.1.0, not 11.x/26.x).
Classifier: Stripped to FP16 state_dict .pt (loaded natively via timm 0.9.12).
